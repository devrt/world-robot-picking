...
PA10Controller::PA10Controller(RTC::Manager* manager)
  : RTC::DataFlowComponentBase(manager),
    ...
    m_beltanglesIn("beltangles", m_beltangles),
    m_beltvelsIn("beltvels", m_beltvels),
    m_belttorqueOut("belttorque", m_belttorque),
    // </rtc-template>
    dummy(0)
{
...
RTC::ReturnCode_t PA10Controller::onInitialize()
{
  ...
  addInPort("beltangles", m_beltanglesIn);
  addInPort("beltvels", m_beltvelsIn);
  
  // Set OutPort buffer
  addOutPort("torque", m_torqueOut);
  addOutPort("belttorque", m_belttorqueOut);
